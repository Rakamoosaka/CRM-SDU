      ...
      <div className="flex flex-col items-center mb-8 sm:mb-16 space-y-4 sm:space-y-6 mt-6 sm:mt-12">
        <button
          ...
          className="bg-[#33ADA9] hover:bg-teal-600 text-white font-medium text-lg sm:text-xl py-2 px-12 sm:px-20 rounded-md
               shadow-md hover:shadow-lg transition-all duration-200 min-w-64"
        >
          Proceed
        </button>
        <button
          onClick={() => navigate("/login")}
          className="bg-gray-700 hover:bg-gray-600 text-white font-medium text-lg sm:text-xl py-2 px-4 sm:px-12 rounded-md
               border border-gray-600 shadow-md hover:shadow-lg transition-all duration-200 min-w-64"
        >
          Log in as admin
        </button>
      </div>
